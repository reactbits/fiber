...
function makeWrapper(props) {
	return function (sourceProps, content) {
		var attrs = _extends({}, sourceProps);
		if (props.className) {
...
var Avatar = exports.Avatar = (function (_Component) {
	...
	_createClass(Avatar, [{
		...
		value: function render() {
			...
			var className = (0, _classnames2.default)(props.className, 'avatar', _style2.default.avatar, _style2.default.circled, _defineProperty({}, _style2.default.hover_rotate, props.animated));
			...
			var wrapper = makeWrapper({
				className: _style2.default.online,
				title: props.name
			});
