...
function makePreloader(size) {
	return function () {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(_ClipLoader2.default, { color: '#4DAF7C', size: size + '' })
		);
	};
}
...
var Avatar = exports.Avatar = (function (_Component) {
	...
	_createClass(Avatar, [{
		...
		value: function render() {
			...
			var className = (0, _classnames2.default)(props.className, 'avatar', _style2.default.avatar, (_classNames = {}, _defineProperty(_classNames, _style2.default.online, this.online()), _defineProperty(_classNames, _style2.default.circled, props.circled), _defineProperty(_classNames, _style2.default.hover_rotate, props.animated), _classNames));
