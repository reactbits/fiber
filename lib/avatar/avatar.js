...
function RandomAvatar(props) {
	...
	var size = props.size;
	return _react2.default.createElement('img', { src: (0, _gravatar2.default)(props.src), width: size, height: size, alt: 'avatar' });
}
...
function makeWrapper(props) {
	return function (sourceProps, content) {
		...
		if (props.title) {
			delete attrs.title;
			attrs.className = (0, _classnames2.default)(attrs.className, (0, _cssEffects.hint)());
