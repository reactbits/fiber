...
var ThreadForm = function (_Component) {
  ...
  function ThreadForm(props) {
    ...
    _this.onSubjectFocus = function () {
      _this.setState({ subjectFocused: true });
    };

    _this.onSubjectBlur = function () {
      _this.setState({ subjectFocused: false });
    };

    _this.onBodyFocus = function () {
      _this.setState({ bodyFocused: true });
    };

    _this.onBodyBlur = function () {
      _this.setState({ bodyFocused: false });
    };

    _this.onSubjectChange = function (event) {
      var value = event.target.value || '';
      _this.setState({ subject: value });
    };
