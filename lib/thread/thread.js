...
var Topic = function Topic(props) {
	return _react2.default.createElement(
		'a',
		{ className: 'topic ' + _style2.default.topic, onClick: props.onClick },
...
var msgCount = function msgCount(m) {
	return 1 + (Array.isArray(m.replies) ? m.replies.map(msgCount) : 0);
};
	...
	_createClass(Thread, [{
		...
		value: function render() {
				...
				(function () {
					...
					var sendMessage = function sendMessage(body) {
						if (_lodash2.default.isFunction(props.sendMessage)) {
							props.sendMessage({ threadId: props.id, body: body });
						}
					};
			...
			return _react2.default.createElement(
				'div',
				{ className: className },
				props.topic ? _react2.default.createElement(Topic, { text: props.topic, onClick: collapse }) : null,
				items
			);
		}
	}]);
