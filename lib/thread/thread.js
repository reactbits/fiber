...
var Thread = exports.Thread = function Thread(props) {
	...
	for (var i = 0; i < messages.length; i++) {
		...
		var elem = _react2.default.createElement(_message.Message, { key: msg.id, data: msg, avatarSize: props.avatarSize, fetchUser: props.fetchUser, onAction: props.onAction });
		items.push(elem);
	}
	...
	return _react2.default.createElement(
		...
		items,
		_react2.default.createElement(_messageinput2.default, { submit: sendMessage })
	);
};
