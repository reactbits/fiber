...
var _reactbitsInput2 = _interopRequireDefault(_reactbitsInput);
	...
	_createClass(Dialog, [{
		...
		value: function render() {
			...
			var changeHandler = function changeHandler(name) {
				return function (value, isValid) {
					var _this2$setState;

					var vs = _lodash2.default.assign(_this2.state.validationState, _defineProperty({}, name, isValid));
					_this2.setState((_this2$setState = {}, _defineProperty(_this2$setState, name, value), _defineProperty(_this2$setState, 'validationState', vs), _defineProperty(_this2$setState, 'hiddenInvalidState', true), _this2$setState));
				};
			};
			var inputs = {
				name: {
			...
			var submit = function submit() {
				...
				_this2.props.submit(_lodash2.default.pick(_this2.state, 'name', 'description'));
			};
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							_reflexbox.Box,
							{ col: 12 },
							_react2.default.createElement(_reactbitsInput2.default, inputs.name),
							_react2.default.createElement(_reactbitsInput2.default, inputs.description)
						)
					)
				),
				_react2.default.createElement(
