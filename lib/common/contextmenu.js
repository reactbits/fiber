...
var _contextMenuStyle = require('./contextMenuStyle.scss');

var _contextMenuStyle2 = _interopRequireDefault(_contextMenuStyle);
...
var ContextMenu = function (_Component) {
  ...
  _createClass(ContextMenu, [{
    ...
    value: function render() {
      ...
      var buttonProps = {
        className: (0, _classnames2.default)(_contextMenuStyle2.default.show_button, button.className),
      ...
      var dropdownProps = {
        className: _contextMenuStyle2.default.context_menu,
        ...
        body: _react2.default.createElement(
          'ul',
          { className: _contextMenuStyle2.default.menu_items, onClick: hide },
          this.props.children
        ),
