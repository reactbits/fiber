...
function Action(props) {
	...
	var className = (0, _classnames2.default)((_classNames = {}, _defineProperty(_classNames, (0, _hint2.default)(), true), _defineProperty(_classNames, action, true), _defineProperty(_classNames, _style2.default.action, true), _defineProperty(_classNames, 'pull-right', props.right), _classNames));
