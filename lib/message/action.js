...
function Action(props) {
	...
	var className = (0, _classnames2.default)((_classNames = {
		action: true
	}, _defineProperty(_classNames, action, true), _defineProperty(_classNames, _style2.default.action, true), _defineProperty(_classNames, 'pull-right', props.right), _classNames));
