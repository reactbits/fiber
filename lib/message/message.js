...
var Message = exports.Message = function (_Component) {
	...
	_createClass(Message, [{
		...
		value: function render() {
			...
			var className = (0, _classnames2.default)(_style2.default.message, this.props.className, _style2.default[this.props.theme], _defineProperty({}, _style2.default.reply, !!this.props.isReply));
			var data = this.props.data || this.props;
			var user = data.user;
			var time = getTime(data);
			var fetchUser = (0, _util.promiseOnce)(data.fetchUser || this.props.fetchUser, data);
			var userName = (0, _util.getOrFetch)(fetchUser, user, 'name', 'login');

			var outerAvatar = this.props.theme === 'github';
			var avatarProps = {
				user: user || fetchUser,
			...
			var bodyProps = {
				...
				style: {
					minHeight: (0, _avatar.avatarSize)(this.props.avatarSize) - 16
				}
			};
			...
			return _react2.default.createElement(
				'div',
				{ className: (0, _classnames2.default)(_style2.default.message_wrapper, _style2.default[this.props.theme]) },
				outerAvatar ? _react2.default.createElement(_avatar2.default, avatarProps) : null,
				_react2.default.createElement(
					'div',
					{ className: className, 'data-id': data.id },
					outerAvatar ? null : _react2.default.createElement(_avatar2.default, avatarProps),
					_react2.default.createElement(
						'div',
					...
					this.state.collapsed ? null : _react2.default.createElement(
						'div',
						bodyProps,
						_react2.default.createElement(_reactMarkdown2.default, { source: data.body })
					),
