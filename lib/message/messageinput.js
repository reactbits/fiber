...
var MessageInput = function (_Component) {
  ...
  _createClass(MessageInput, [{
    ...
    value: function render() {
      ...
      var canSubmit = _lodash2.default.isFunction(this.props.canSubmit) ? this.props.canSubmit : function () {
      ...
      var submit = function submit() {
        ...
        _this2.props.submit(value);
      };
      var inputProps = {
        className: (0, _classnames2.default)(_style2.default.input, _style2.default.message_input),
...
MessageInput.defaultProps = {
  focused: false,
  submit: _lodash2.default.noop,
  cancel: _lodash2.default.noop
};
